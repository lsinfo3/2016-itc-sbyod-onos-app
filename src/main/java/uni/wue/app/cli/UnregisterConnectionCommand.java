 ...
 */
@Command(scope="onos", name="unregister-connection", description = "Unregister an existing connection between an user and a service.")
public class UnregisterConnectionCommand extends AbstractShellCommand {
    ...
    protected void execute() {
        System.out.println("Nothing done. Command has to be implemented.");
    }
}