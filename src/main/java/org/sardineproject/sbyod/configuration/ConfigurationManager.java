        ...
        private void reconfigureNetwork(ByodConfig cfg){
            ...
            if(cfg.portalIp() != null && cfg.portalPort() != -1){
                ...
                if(!portal.getHost().ipAddresses().contains(cfg.portalIp()) ||
                    ...
                    log.info("ConfigurationManager: Set portal ip to {} and port to {} and updated portal", cfg.portalIp(), cfg.portalPort());
                }
                ...
                if(!portal.getHost().ipAddresses().contains(cfg.portalIp())) {
                    ...
                    log.info("ConfigurationManager: Set portal ip to {} and updated portal", cfg.portalIp());
                }
            } else{
                log.info("ConfigurationManager: No portal configured");
            }
            ...
            if(cfg.defaultGateway() != null){
                ...
                log.info("ConfigurationManager: Activated dns service for default gateway={}", cfg.defaultGateway());
            }
